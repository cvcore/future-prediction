...
from efficientPS.modules.losses import smooth_l1
from efficientPS.utils.bbx import ious, calculate_shift, mask_overlap, bbx_overlap
from efficientPS.utils.misc import Empty
from efficientPS.utils.nms import nms
...
class AnchorMatcher:
    ...
    def __call__(self, anchors, bbx, iscrowd, valid_size):
        ...
        for bbx_i, iscrowd_i, valid_size_i in zip(bbx, iscrowd, valid_size):
            ...
            #print (bbx_i.shape,iscrowd_i.shape,'yay')
            try:
                ...
                if self.void_threshold != 0 and iscrowd_i is not None:
                    #print(iscrowd_i.dtype,'type')
                    if iscrowd_i.dtype == torch.uint8 or iscrowd_i.dtype == torch.bool:
