...
from efficientPS.utils.sequence import pack_padded_images
from efficientPS.utils.bbx import invert_roi_bbx
from efficientPS.utils.roi_sampling import roi_sampling
...
class SemanticSegAlgo:
    ...
    def _logits(head, x, valid_size, img_size):
        sem_logits, sem_feat = head(x)
        return sem_logits, sem_feat
    ...
    def training(self, head, x, sem, valid_size, img_size):
        ...
        sem_logits_, sem_feat = self._logits(head, x, valid_size, img_size)
