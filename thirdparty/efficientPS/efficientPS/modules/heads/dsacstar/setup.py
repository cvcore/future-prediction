...
opencv_inc_dir = '/home/gosalan/local/include/' # directory containing OpenCV header files
opencv_lib_dir = '/home/gosalan/local/lib/' # directory containing OpenCV library files
