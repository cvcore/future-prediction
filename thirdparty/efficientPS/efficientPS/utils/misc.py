...
from efficientPS.modules.misc import ActivatedAffine, ActivatedGroupNorm
from efficientPS.modules.heads.multi_loss import MultiLossHead
from . import scheduler as lr_scheduler

NORM_LAYERS = [ABN, nn.BatchNorm1d, nn.BatchNorm2d, nn.BatchNorm3d, nn.GroupNorm]
OTHER_LAYERS = [nn.Linear, nn.Conv1d, nn.Conv2d, nn.Conv3d, nn.ConvTranspose1d, nn.ConvTranspose2d, nn.ConvTranspose3d, ops.DeformConv2d]
NON_LAYERS = [MultiLossHead]
